            ...
            EmptyDataText="<center><span style='color:Red;'>ไม่พบข้อมูล</span></center>" 
                ...
                <Columns>
                    <asp:TemplateField HeaderText="">
                        <ItemTemplate>
                            <asp:Button ID="btnTransfer" runat="server" CssClass="Button" Width="70px" Text="โอนงาน" CommandArgument ='<%# Eval("Username") %>' OnClick="btnTransfer_Click" />
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="สถานะการทำงาน">
                        ...
                        <ItemStyle Width="120px" HorizontalAlign="Left" CssClass="Hidden"  />
                        <FooterStyle Width="120px" HorizontalAlign="Left" CssClass="Hidden"  />
                    </asp:TemplateField>
                        ...
                        <tr>        
                            <td class="style1">                                                                                                                                                                                            
                                ...
                                <asp:GridView ID="gvPopMKT" runat="server" AutoGenerateColumns="False" GridLines="Horizontal" BorderWidth="0px" 
                                    EnableModelValidation="True" Width="1730px" EmptyDataText="<center><span style='color:Red;'>ไม่พบข้อมูล</span></center>"
