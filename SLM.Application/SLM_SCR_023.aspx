<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SaleLead.Master" AutoEventWireup="true" CodeBehind="SLM_SCR_023.aspx.cs" Inherits="SLM.Application.SLM_SCR_023" %>
    ...
    <script language="javascript" type="text/javascript">
        function ConfirmEditSave() {
            ...
            if (cb != null && cb.checked && listbox_selected != null) {
                ...
                if (count == 0) {
                    return confirm('ต้องการลบสาขาทั้งหมดของข้อมูลการจ่ายงานนี้ ใช่หรือไม่');
                }
            }
            return true;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="upSearch" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <table cellpadding="2" cellspacing="0" border="0">
                ...
                <tr>
                    <td class="ColInfo">
                        <asp:RadioButton ID="rbProduct" runat="server" Text="ผลิตภัณฑ์/บริการ" AutoPostBack="true" 
                            GroupName="SearchType" Checked="true" oncheckedchanged="rbProduct_CheckedChanged" />
                    </td>
                    <td class="ColInput">
                ...
                <tr>
                    <td class="ColInfo">
                        <asp:RadioButton ID="rbCampaign" runat="server" Text="แคมเปญ" AutoPostBack="true" GroupName="SearchType" oncheckedchanged="rbCampaign_CheckedChanged" />
                    </td>
                    <td class="ColInput">
    ...
    <asp:UpdatePanel ID="upResult" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:Button ID="btnAddConfig" runat="server" Text="เพิ่มการกำหนดค่าการจ่ายงาน" Width="200px" OnClientClick="DisplayProcessing();" 
            ...
            <asp:GridView ID="gvResult" runat="server" AutoGenerateColumns="False" Width="1000px" 
                ...
                <Columns>
                     <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            <asp:ImageButton ID="imbEdit" runat="server" ImageUrl="~/Images/edit.gif" CommandArgument='<%# Container.DisplayIndex %>' OnClick="imbEdit_Click" ToolTip="แก้ไขการกำหนดค่าการจ่ายงาน" OnClientClick="DisplayProcessing();" />
                        </ItemTemplate>
    ...
    <asp:UpdatePanel ID="upPopup" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Button runat="server" ID="btnPopup" Width="0px" CssClass="Hidden"/>
	            <asp:Panel runat="server" ID="pnPopup" style="display:none" CssClass="modalPopupConfigAssign">
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;<asp:Image ID="imgSaveNote" runat="server" ImageUrl="~/Images/Assign.png" />
                        ...
                        <tr style="vertical-align:top;">
                            ...
                            <td class="ColInput">
                                <asp:UpdatePanel ID="upStaffTypeSection" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="cmbStaffTypePopup" runat="server" CssClass="Dropdownlist" Width="207px" AutoPostBack="true" 
                                            onselectedindexchanged="cmbStaffTypePopup_SelectedIndexChanged"></asp:DropDownList>
                                        <br />
                        ...
                        <ContentTemplate>
                            <table cellpadding="2" cellspacing="0" border="0">
                                ...
                                <tr>
                                    <td style="width:20px;"></td>
                                    <td colspan="3">
                                        <asp:Button ID="btnSave" runat="server" Text="บันทึก" CssClass="Button" Width="100px" OnClientClick="if (ConfirmEditSave()) { DisplayProcessing(); return true; } else { return false; }" onclick="btnSave_Click" />
